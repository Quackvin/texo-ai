...
<head>
  ...
  <title>Welcome to Texo AI</title>
  <style>
    body {{
...
<body>
  <div class="container">
    <div class="logo-container">
      <img src="https://i.postimg.cc/WdNtRx5Z/kortix-suna-logo.png" alt="Texo AI Logo" class="logo">
    </div>
    <h1>Welcome to Texo AI!</h1>

    <p>Hi {user_name},</p>

    <p><em><strong>Welcome to Texo AI — we're excited to have you on board!</strong></em></p>
