...
export function UpgradeDialog({ open, onOpenChange, onDismiss }: UpgradeDialogProps) {
  ...
  const handleUpgradeClick = () => {
    ...
    onOpenChange(false);
    localStorage.setItem('texo_upgrade_dialog_displayed', 'true');
  };
      ...
      <DialogContent onPointerDownOutside={(e) => e.preventDefault()} className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="flex items-center">
            ...
            Unlock the Full Texo Experience
          </DialogTitle>
          <DialogDescription>
            You're currently using Texo's free tier with limited capabilities.
